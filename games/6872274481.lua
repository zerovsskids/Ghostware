...
run(function()
	...
	PartyPopperExploit = vape.Categories.Blatant:CreateModule({
...
run(function()
	...
	TrainWhistleExploit = vape.Categories.Blatant:CreateModule({
...
run(function()
    ...
    AdetundeExploit = vape.Categories.World:CreateModule({
